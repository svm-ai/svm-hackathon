...
class ProteinBindModel(nn.Module):
    ...
    def __init__(
        ...
        self._create_modality_postprocessors()
        pass
    ...
    def forward(self, inputs):
        ...
        for modality_key, modality_value in inputs.items():
            ...
            modality_trunk_output = self.modality_trunks[modality_key](
                modality_value
            )

            modality_embedding_value = self.modality_heads[modality_key](
                modality_trunk_output
            )

            outputs[modality_key] = modality_embedding_value
